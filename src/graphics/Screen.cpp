...
void heltecV3ServicePageDrawFrame(OLEDDisplay *display,
                                  OLEDDisplayUiState *state, int16_t x,
                                  int16_t y);
bool heltecV3MeshHealthPageEnabled();
void heltecV3MeshHealthPageDrawFrame(OLEDDisplay *display,
                                     OLEDDisplayUiState *state, int16_t x,
                                     int16_t y);
bool heltecV3AntennaPageEnabled();
void heltecV3AntennaPageDrawFrame(OLEDDisplay *display,
                                  OLEDDisplayUiState *state, int16_t x,
                                  int16_t y);
#endif

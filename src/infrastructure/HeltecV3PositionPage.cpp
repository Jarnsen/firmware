...
// 8-digit MGRS (10 m display resolution). Internal position/distance logic keeps
// the full latitude/longitude precision; only the OLED presentation is rounded
// down to the normal 10 m MGRS grid precision.
...
void drawCenteredLine(OLEDDisplay *display, int16_t x, int16_t y, const char *text)
{

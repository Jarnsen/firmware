...
def _gradient_polygon(
    base: Image.Image, points, top: str, bottom: str, *, horizontal: bool = False
) -> None:
...
def _build_source() -> Image.Image:
    ...
    background = ImageOps.colorize(radial, black="#12345f", white="#030b17").convert(
        "RGBA"
    )
    ...
    _gradient_polygon(
        background, [(42, 760), (292, 408), (315, 594)], "#f8fbff", "#aabbd0"
    )
    _gradient_polygon(
        background,
        [(292, 408), (315, 594), (356, 507)],
        "#dbe5f2",
        "#6f819a",
        horizontal=True,
    )
    ...
    _gradient_polygon(
        background,
        [(561, 449), (676, 597), (548, 722), (756, 626)],
        "#f8fbff",
        "#a8bbd0",
    )
    ...
    _gradient_polygon(
        background,
        [(756, 626), (806, 479), (806, 650)],
        "#cfdbea",
        "#6f8199",
        horizontal=True,
    )
    _gradient_polygon(
        background, [(806, 479), (969, 801), (806, 650)], "#ffffff", "#b6c7db"
    )
